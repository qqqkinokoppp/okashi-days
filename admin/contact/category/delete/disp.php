...
//商品カテゴリの取得
$delete_categories = $db ->getContactCategoryAll();
...
<div class="container">
    ...
    <main>
        <table class="admin" width="300">
            ...
            <?php foreach($delete_categories as $delete_category):?>
            <?php if($i%2 === 0):?>
            <tr class="even">
            <?php else:?>
            <tr class="odd">
            <?php endif;?>
                ...
                <td class="align-left">
                    <?php
                    print $delete_category['contact_category'];
                    ?>
                </td>
                <td>
                    <form action="index.php" method="post">
                    <!--選択した商品カテゴリのIDを渡す-->
                        <input type="hidden" name="contact_category_id" value="<?= $delete_category['id'];?>">
