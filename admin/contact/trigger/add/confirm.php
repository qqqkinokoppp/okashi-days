...
$_SESSION['post']['add_contact_trigger'] = $post;
...
//きっかけが入力されていなかったら
if(empty($post['contact_trigger']))
{
    $_SESSION['error']['add_contact_trigger'] = 'きっかけを入力してください。';
    // print '通った';
    // exit;
...
//きっかけが50字以上だったら
if(mb_strlen($post['contact_trigger']) > 50)
{
    $_SESSION['error']['add_contact_trigger'] = 'きっかけは50文字以内です。';
    // print '通った';
    // exit;
    header('Location:./index.php');
    exit;
        ...
        <form action="./process.php" method="post">
            <table class="list" height="200">
                <tr>
                    <th>カテゴリ名</th>
                    <td class="align-left">
                        <?php print $post['contact_trigger'];?>
                    </td>
                </tr>
            </table>
            <input type="hidden" name="contact_trigger" value="<?php print $post['contact_trigger'];?>">
