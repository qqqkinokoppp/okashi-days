...
if($post['expiration_date'] !== '')
{
    ...
    {
        $_SESSION['error']['add_news'] = '掲載期限日を正しく入力してください。';
        header('Location:./index.php');
        exit;
    }
    ...
    $_SESSION['post']['add_news']['expiration_date'] = $post['expiration_date'];
        ...
        <form action="./process.php" method="post">
            <table class="list" height="200">
                ...
                <tr>
                    <th>掲載期限日</th>
                    <td class="align-left">
                    <?= $_SESSION['post']['add_news']['expiration_date'];?>
                    </td>
                </tr>
