        ...
        <main>
            ...
            <table class="contact">
                ...
                <tr class="even">
                    ...
                    <td>
                        <form action="./contact/category/add/" method="post">
                            <input type="submit" value="お問い合わせカテゴリ登録">
                        </form>
                        <form action="./contact/category/edit/disp.php" method="post">
                            <input type="submit" value="お問い合わせカテゴリ修正">
                        </form>
                        <form action="./contact/category/delete/disp.php" method="post">
                            <input type="submit" value="お問い合わせカテゴリ削除">
                        </form>
                    </td>
                </tr>
                <tr class="even">
                    ...
                    <td>
                        <form action="./contact/trigger/add/" method="post">
                            <input type="submit" value="サイトを知ったきっかけ登録">
                        </form>
                        <form action="./contact/trigger/edit/disp.php" method="post">
                            <input type="submit" value="サイトを知ったきっかけ修正">
                        </form>
                        <form action="./contact/trigger/delete/disp.php" method="post">
                            <input type="submit" value="サイトを知ったきっかけ削除">
                        </form>
                    </td>
                </tr>
                <tr class="even">
                    ...
                    <td>
                        <form action="./contact/download/" method="post">
                            <input type="submit" value="お問い合わせCSVダウンロード">
                        </form>
                    </td>
                </tr>
            </table>
