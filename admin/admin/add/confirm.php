...
if($post['user_name'] === '')
{
    $_SESSION['error']['adminadd'] = 'ログインユーザー名を入力してください。';
    // print '通った';
    // exit;
...
{
    $_SESSION['error']['adminadd'] = 'パスワードを入力してください。';
    // print '通った';
    // exit;
    header('Location:./index.php');
    exit;
...
{
    $_SESSION['error']['adminadd'] = '確認用パスワードを入力してください。';
    // print '通った';
    // exit;
    header('Location:./index.php');
    exit;
...
if(empty($post['name']))
{
    $_SESSION['error']['adminadd'] = '管理者氏名を入力してください。';
    // print '通った';
    // exit;
    header('Location:./index.php');
    exit;
...
if(empty($post['email']))
{
    $_SESSION['error']['adminadd'] = 'メールアドレスを入力してください。';
    // print '通った';
    // exit;
    header('Location:./index.php');
    exit;
...
{
    $_SESSION['error']['adminadd'] = 'パスワードが一致しません。';
    //print '通った';
    //exit;
    header('Location:./index.php');
    exit;
...
{
    $_SESSION['error']['adminadd'] = 'パスワードは半角英数で入力してください。';
    // print '通った';
    // exit;
    header('Location:./index.php');
    exit;
...
{
    $_SESSION['error']['adminadd'] = 'ログインユーザー名は半角英数で入力してください。';
    header('Location:./index.php');
    exit;
}
...
{
    $_SESSION['error']['adminadd'] = 'メールアドレスを正しく入力してください。';
    header('Location:./index.php');
    exit;
}
